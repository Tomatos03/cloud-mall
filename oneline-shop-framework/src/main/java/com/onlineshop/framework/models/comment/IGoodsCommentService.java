...
public interface IGoodsCommentService extends IService<GoodsComment> {
     ...
     * @return 分页结果
     */
    IPage<GoodsCommentVO> getCommentsByGoodsId(Long goodsId, int page, int size);
     ...
     * @return 分页结果
     */
    IPage<GoodsCommentCardVO> getCommentsForMerchant(int page, int size, Boolean hasReply);
