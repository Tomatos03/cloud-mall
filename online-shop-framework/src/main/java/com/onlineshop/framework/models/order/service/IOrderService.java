...
public interface IOrderService extends IService<Order> {
     ...
     * @return 订单聚合视图分页结果
     * @throws BizException 当查询参数异常时
     */
    IPage<OrderAggregateVO> pageQueryForUser(OrderParamsDTO queryDTO);
     ...
     * @return 是否成功
     * @throws BizException 当订单不存在或订单状态不符合要求时
     */
     ...
     */
    IPage<OrderVO> pageQuery(OrderParamsDTO queryDTO);
     ...
     * @return 订单分页结果（OrderVO视图对象）
     */
    IPage<OrderVO> pageQueryForMerchant(OrderParamsDTO queryDTO);
